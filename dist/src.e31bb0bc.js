...
},{"./bundle-url":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"index.less":[function(require,module,exports) {
...
var addRandomWidthItem = function addRandomWidthItem(containerSelector) {
  var width = Math.random() * 60 + 30;
  var item = $("<li style=\"width:".concat(width, "px\">").concat(itemsNumber++, "</li>"));
...
var shouldCollapsed = function shouldCollapsed() {
  var contentWidth = $(ContainerSelector)[0].scrollWidth;
  var maxWidth = $(ContainerSelector).width();
  return contentWidth > maxWidth;
};

var changeBarrierItem = function changeBarrierItem(position) {
...
var setBarrierItem = function setBarrierItem(start, end) {
  ...
  var current = getNewBarrierPosition(start, end);
...
$(document).ready(function () {
  ...
  $(document.body).click(function (event) {
    ...
    var shouldHide = event.target && target.closest(ContainerSelector).length === 0 && target.closest("#addItem").length === 0;
...
},{"./index.less":"index.less","jquery":"../node_modules/jquery/dist/jquery.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
